...
<#
.SYNOPSIS
Enforcement code for Manufacturing Computers Only - Pilot Release - V2.0
...
.EXAMPLE
dcManufacturing -ComputerName localhost
...
.EXAMPLE
dcManufacturing -FilePath "C:\output.txt"

This example will be labeled "EXAMPLE 2" when help is displayed to the user.
#>
configuration dcManufacturingPilot
{
    param
    (
...
} #End Configuration dcManufacturingPilot
